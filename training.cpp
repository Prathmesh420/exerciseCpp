...
float bmr_f (float h, float w){
    float bmr = (gender=1)?13.397*w+4.799*h-5.677*age+88.362:
...
float running (float bmr){
    ...
    cout<<"\nRunning";
    while(true){
        cout<<"\n1. Distance & Time"<<endl<<"2. Speed & Time"<<endl;
        cout<<"Select: ";
        if(cin>>mode){
            if(mode==1 || mode==2){
                break;
...
float skipping (float bmr){
    ...
    cout<<"\nSkipping";
    while(true){
        cout<<"\n1. Skipping & Time"<<endl<<"2. Skip Speed & Time"<<endl;
        cout<<"Select: ";
        if(cin>>mode){
            if(mode==1 || mode==2){
                break;
...
float sidejumps (){
    float sidejumps_count; float sidejumps_time;
    cout<<"\nSidejumps";
    while(true){
        cout<<"\n1. No. of Sidejumps: "<<endl<<"2. Minutes Sidejumps done for: "<<endl;
        cout<<"Select: ";
        if(cin>>mode){
            if(mode==1 || mode==2){
                break;
